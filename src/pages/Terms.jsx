    ...
    return (
        <div className='w-full font-poppins bg-white'>
            ...
            <div className='py-20 w-[90%] md:w-[80%] mx-auto lg:[70%] gap-10 h-fit bg-white flex flex-col items-center justify-center '>
                ...
                Last updated: August 07, 2023 <br />
                ...
                * Country refers to: Turkey <br />

                * Company (referred to as either "the Company", "We", "Us" or "Our" in this
                Agreement) refers to 58 Works™. <br />
                ...
                * Terms and Conditions (also referred as "Terms") mean these Terms and
                ...
                been created with the help of the https://www.termsfeed.com/terms-conditions-generator/. <br />
                ...
                * Third-party Social Media Service means any services or content (including
                ...
                may be displayed, included or made available by the Service. <br />

                * Website refers to 58 Works™, accessible from https://58works.com.tr <br />
                ...
                * You means the individual accessing or using the Service, or the company,
                ...
                to all visitors, users and others who access or use the Service.<br />

                By accessing or using the Service You agree to be bound by these Terms and
                Conditions. If You disagree with any part of these Terms and Conditions then
                You may not access the Service.<br />

                You represent that you are over the age of 18. The Company does not permit
                those under 18 to use the Service.<br />
                ...
                Our Privacy Policy carefully before using Our Service.<br />

                Links to Other Websites<br />

                Our Service may contain links to third-party web sites or services that are
                not owned or controlled by the Company.<br />
                ...
                of any third-party web sites or services that You visit.<br />

                Termination<br />

                We may terminate or suspend Your access immediately, without prior notice or
                liability, for any reason whatsoever, including without limitation if You
                breach these Terms and Conditions.<br />
                ...
                will be limited to the greatest extent permitted by law.<br />
                ...
                be error free or that any errors or defects can or will be corrected.<br />

                Without limiting the foregoing, neither the Company nor any of the company's
                provider makes any representation or warranty of any kind, express or implied: <br />
                (i) as to the operation or availability of the Service, or the information,
                content, and materials or products included thereon;<br /> (ii) that the Service
                will be uninterrupted or error-free;<br /> (iii) as to the accuracy, reliability, or
                currency of any information or content provided through the Service;<br /> or (iv)
                ...
                timebombs or other harmful components.<br />

                Some jurisdictions do not allow the exclusion of certain types of warranties
                or limitations on applicable statutory rights of a consumer, so some or all of
                the above exclusions and limitations may not apply to You. But in such a case
                the exclusions and limitations set forth in this section shall be applied to
                the greatest extent enforceable under applicable law.<br />

                Governing Law<br />

                The laws of the Country, excluding its conflicts of law rules, shall govern
                this Terms and Your use of the Service. Your use of the Application may also
                be subject to other local, state, national, or international laws.<br />

                Disputes Resolution<br />

                If You have any concern or dispute about the Service, You agree to first try
                to resolve the dispute informally by contacting the Company.<br />

                For European Union (EU) Users<br />


                If You are a European Union consumer, you will benefit from any mandatory
                provisions of the law of the country in which you are resident in.<br />
                ...
                remaining provisions will continue in full force and effect.<br />
                ...
                constitutes a material change will be determined at Our sole discretion.<br />
